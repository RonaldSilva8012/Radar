...
public class Radar {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            do {
                System.out.println("Qual operacao deseja realizar? 1- Realizar consulta 2- Sair do programa ");
                ...
                switch (opcao) {
                    ...
                    case 1 -> {
                        ...
                        if (velocidadeConsiderada <= limiteVia) {
                            ...
                            System.out.println("Penalidades: Conversao em advertencia por escrito (se no reincidente em 12 meses).");
                        ...
                        System.out.println("\nDeseja realizar outra consulta? 1- Sim | 2- Sair: ");
                        opcao = scanner.nextInt();
                    }
